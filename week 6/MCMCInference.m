...
if bSwendsenWang
  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          edge_factor = F(E2F{u(i), v(i)}(1)); % get correspondence factor of this edge
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                d = edge_factor.card(1);
                equal_ass = 1:d;
                equal_ass = [equal_ass',equal_ass'];
                equal_case = GetValueOfAssignment(edge_factor,equal_ass);
                q_ij = sum(equal_case)/sum(edge_factor.val);
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          else
