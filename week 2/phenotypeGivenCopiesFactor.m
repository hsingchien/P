...
possibilities = IndexToAssignment(1:prod(phenotypeFactor.card),phenotypeFactor.card);
for i = 1 : 2: length(possibilities)
   pheno = possibilities(i,1);
   Pgeno1 = possibilities(i,2);
   Pgeno2 = possibilities(i,3);
   phenotypeFactor.val(i) = alphaList(allelesToGenotypes(Pgeno1,Pgeno2));
