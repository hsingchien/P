...
alleleFreqs = [0.1; 0.9];
alphaList = [0.8; 0.6; 0.1];
sampleFactorList_1 = load('sampleFactorList.mat'); % Comment out this line for testing
...
alphaListThree = [0.8; 0.6; 0.1; 0.5; 0.05; 0.01];
sampleFactorListDecoupled_2 = load('sampleFactorListDecoupled.mat'); % Comment out this line for testing
