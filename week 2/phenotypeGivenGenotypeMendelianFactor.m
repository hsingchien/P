...
if isDominant == 1
    phenotypeFactor.val(AssignmentToIndex([1,1], [2,3])) = 1;
    phenotypeFactor.val(AssignmentToIndex([1,2], [2,3])) = 1;
    phenotypeFactor.val(AssignmentToIndex([2,3], [2,3])) = 1;
else
    phenotypeFactor.val(AssignmentToIndex([1,3], [2,3])) = 1;
    phenotypeFactor.val(AssignmentToIndex([2,1], [2,3])) = 1;
    phenotypeFactor.val(AssignmentToIndex([2,2], [2,3])) = 1;
end
